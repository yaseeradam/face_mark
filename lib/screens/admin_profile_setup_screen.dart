...
class _AdminProfileSetupScreenState
      ...
      SnackBar(
        content: Text(
          result['success']
              ...
              : (result['error'] ?? 'Failed to setup Face ID'),
        ),
  ...
  Widget build(BuildContext context) {
    ...
    final String role = (_profile['role'] ?? 'Administrator')
        .toString()
        .toUpperCase();
